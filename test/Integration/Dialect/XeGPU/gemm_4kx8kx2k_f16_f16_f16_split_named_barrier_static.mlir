...
module @gemm attributes {gpu.container_module} {
  func.func @test(%A: memref<4096x8192xf16>, %B: memref<8192x2048xf16>, %C: memref<4096x2048xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %wg_X: index, %wg_Y: index, %wg_Z: index, %sg_X: index, %sg_Y: index, %sg_Z: index, %prefetch_distance: index, %barrier_distance: index) -> memref<4096x2048xf16> attributes {llvm.emit_c_interface} {

    %A_gpu = gpu.alloc () : memref<4096x8192xf16>
    gpu.memcpy %A_gpu, %A : memref<4096x8192xf16>, memref<4096x8192xf16>
    %B_gpu = gpu.alloc () : memref<8192x2048xf16>
    gpu.memcpy %B_gpu, %B : memref<8192x2048xf16>, memref<8192x2048xf16>
    %C_gpu = gpu.alloc () : memref<4096x2048xf16>
    gpu.memcpy %C_gpu, %C : memref<4096x2048xf16>, memref<4096x2048xf16>


    // gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_split_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<4096x8192xf16>, %B_gpu : memref<8192x2048xf16>, %C_gpu : memref<4096x2048xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)

    gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_named_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<4096x8192xf16>, %B_gpu : memref<8192x2048xf16>, %C_gpu : memref<4096x2048xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)


    %C_host = memref.alloc () : memref<4096x2048xf16>
    gpu.memcpy %C_host, %C_gpu : memref<4096x2048xf16>, memref<4096x2048xf16>

    gpu.dealloc  %A_gpu : memref<4096x8192xf16>
    gpu.dealloc  %B_gpu : memref<8192x2048xf16>
    gpu.dealloc  %C_gpu : memref<4096x2048xf16>
    return %C_host : memref<4096x2048xf16>
  }
  gpu.module @gemm_kernels attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    ...
    gpu.func @gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_split_barrier(%A: memref<4096x8192xf16>, %B: memref<8192x2048xf16>, %C: memref<4096x2048xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      // constants
      ...
      // stage 1
      %A_sg_prefetch_tile_iter0 = xegpu.create_nd_tdesc %A[%A_sg_prefetch_offset_x, %c0] : memref<4096x8192xf16> -> !xegpu.tensor_desc<8x32xf16>
      ...
      %B_sg_prefetch_tile_iter0 = xegpu.create_nd_tdesc %B[%B_sg_prefetch_offset_x, %B_sg_prefetch_offset_y]: memref<8192x2048xf16> -> !xegpu.tensor_desc<8x32xf16>
      ...
      %A_sg_init_tile_0 = xegpu.create_nd_tdesc %A[%C_sg_tile_offset_x, %c0] : memref<4096x8192xf16> -> !xegpu.tensor_desc<32x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>

      //create B tiles, total of 32x64 = 4 B tiles of size 32x16
      %B_sg_init_tile_0 = xegpu.create_nd_tdesc %B[%c0, %C_sg_tile_offset_y] : memref<8192x2048xf16> -> !xegpu.tensor_desc<32x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>
      ...
      %k_loop_result:21 = scf.for %k = %c0 to %c8192 step %c32 iter_args (
      ...
      %c_sg_tile_00 = xegpu.create_nd_tdesc %C[%C_sg_tile_offset_x, %C_sg_tile_offset_y] : memref<4096x2048xf16> -> !xegpu.tensor_desc<8x32xf16>
    ...
    gpu.func @gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_named_barrier(%A: memref<4096x8192xf16>, %B: memref<8192x2048xf16>, %C: memref<4096x2048xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      // constants
      %c256 = arith.constant 256 : index
      %c512 = arith.constant 512 : index
      %c128 = arith.constant 128 : index
  ...
  // compute CPU reference (takes minutes)
  func.func @cpu_reference(%A : memref<4096x8192xf16>, %B : memref<8192x2048xf16>, %C : memref<4096x2048xf32>, %M: index, %K: index, %N: index) {
    %c16 = arith.constant 16 : index
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    scf.for %i = %c0 to %M step %c1 {
      scf.for %j = %c0 to %N step %c1 {
        %c_curr = memref.load %C[%i, %j] : memref<4096x2048xf32>
        %c_val = scf.for %k_tile = %c0 to %K step %c16 iter_args(%c_partial = %c_curr) -> f32 {
          %c_val_dpas = scf.for %k = %c0 to %c16 step %c1 iter_args(%c_dpas_partial = %c_partial) -> f32 {
            ...
            %a_val = memref.load %A[%i, %k_dpas] : memref<4096x8192xf16>
            %b_val = memref.load %B[%k_dpas, %j] : memref<8192x2048xf16>
        ...
        memref.store %c_val_ , %C[%i, %j] : memref<4096x2048xf32>
      }
    }
    return
  }
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %A = memref.alloc() : memref<4096x8192xf16>
    %B = memref.alloc() : memref<8192x2048xf16>
    %C = memref.alloc() : memref<4096x2048xf16>
    %C_ref = memref.alloc() : memref<4096x2048xf32>

    // -------------------------------------- End of GEMM parameters -------------------------------------- //

    %A_random = memref.cast %A : memref<4096x8192xf16> to memref<*xf16>
    ...
    %B_random = memref.cast %B : memref<8192x2048xf16>  to memref<*xf16>
    ...
    scf.for %i = %c0 to %M step %c1 {
      scf.for %j = %c0 to %N step %c1 {
        memref.store %c0_f16, %C[%i, %j] : memref<4096x2048xf16>
        memref.store %c0_f32, %C_ref[%i, %j] : memref<4096x2048xf32>
      }
    }
    ...
    // run GPU
    %2 = call @test(%A, %B, %C, %M, %K, %N, %wg_M, %wg_K, %wg_N, %sg_M, %sg_K, %sg_N, %wg_X, %wg_Y, %wg_Z, %sg_X, %sg_Y, %sg_Z, %prefetch_distance, %barrier_distance) : (memref<4096x8192xf16>, memref<8192x2048xf16>, memref<4096x2048xf16>, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index) -> memref<4096x2048xf16>

    call @cpu_reference(%A, %B, %C_ref, %M, %K, %N) : (memref<4096x8192xf16>, memref<8192x2048xf16>, memref<4096x2048xf32>, index, index, index) -> ()

    // // %cast = memref.cast %A : memref<?x?xf16> to memref<*xf16>
    // // call @printMemrefF16(%cast) : (memref<*xf16>) -> ()
    %cast_C = memref.cast %2 : memref<4096x2048xf16> to memref<*xf16>
    %cast_C_ref = memref.cast %C_ref : memref<4096x2048xf32> to memref<*xf32>
    ...
    memref.dealloc %A : memref<4096x8192xf16>
    memref.dealloc %B : memref<8192x2048xf16>
    memref.dealloc %C : memref<4096x2048xf16>
    memref.dealloc %C_ref : memref<4096x2048xf32>
    return
  }

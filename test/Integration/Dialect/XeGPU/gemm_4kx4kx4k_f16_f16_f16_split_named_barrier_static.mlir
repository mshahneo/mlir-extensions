...
module @gemm attributes {gpu.container_module} {
  func.func @test(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %wg_X: index, %wg_Y: index, %wg_Z: index, %sg_X: index, %sg_Y: index, %sg_Z: index, %prefetch_distance: index, %barrier_distance: index) -> memref<4096x4096xf16> attributes {llvm.emit_c_interface} {
    ...
    // gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_split_barriers blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<4096x4096xf16>, %B_gpu : memref<4096x4096xf16>, %C_gpu : memref<4096x4096xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)

    gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_named_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<4096x4096xf16>, %B_gpu : memref<4096x4096xf16>, %C_gpu : memref<4096x4096xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)


    // %C_host = memref.alloc () : memref<4096x4096xf16>
    // gpu.memcpy %C_host, %C_gpu : memref<4096x4096xf16>, memref<4096x4096xf16>

    // gpu.dealloc  %A_gpu : memref<4096x4096xf16>
    // gpu.dealloc  %B_gpu : memref<4096x4096xf16>
    // gpu.dealloc  %C_gpu : memref<4096x4096xf16>
    // return %C_host : memref<4096x4096xf16>
  ...
  gpu.module @gemm_kernels attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    ...
    gpu.func @gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_split_barriers(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      // constants
      ...
      %barrier_nth_iter = arith.muli %c32, %barrier_distance : index
    ...
    gpu.func @gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_named_barrier(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      // constants
      %c256 = arith.constant 256 : index
      %c512 = arith.constant 512 : index
      %c128 = arith.constant 128 : index
  ...
  // compute CPU reference (takes minutes)
  func.func @cpu_reference(%A : memref<4096x4096xf16>, %B : memref<4096x4096xf16>, %C : memref<4096x4096xf32>, %M: index, %K: index, %N: index) {
    %c16 = arith.constant 16 : index
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    // run GPU
    %2 = call @test(%A, %B, %C, %M, %K, %N, %wg_M, %wg_K, %wg_N, %sg_M, %sg_K, %sg_N, %wg_X, %wg_Y, %wg_Z, %sg_X, %sg_Y, %sg_Z, %prefetch_distance, %barrier_distance) : (memref<4096x4096xf16>, memref<4096x4096xf16>, memref<4096x4096xf16>, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index, index) -> memref<4096x4096xf16>

    call @cpu_reference(%A, %B, %C_ref, %M, %K, %N) : (memref<4096x4096xf16>, memref<4096x4096xf16>, memref<4096x4096xf32>, index, index, index) -> ()

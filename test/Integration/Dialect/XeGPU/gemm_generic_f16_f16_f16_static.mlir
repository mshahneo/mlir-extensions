...
module @gemm attributes {gpu.container_module} {
  func.func @test(%A: memref<?x?xf16>, %B: memref<?x?xf16>, %C: memref<?x?xf16>, %M: index, %K: index, %N: index,  %wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %wg_X: index, %wg_Y: index, %wg_Z: index, %sg_X: index, %sg_Y: index, %sg_Z: index, %prefetch_distance: index, %barrier_distance: index) -> memref<?x?xf16> attributes {llvm.emit_c_interface} {
    ...
    // gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_256_Kblock_32_sgX_32_sgY_64_split_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<?x?xf16>, %B_gpu : memref<?x?xf16>, %C_gpu : memref<?x?xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)
    ...
    // gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_128_Kblock_32_sgX_32_sgY_32_split_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<?x?xf16>, %B_gpu : memref<?x?xf16>, %C_gpu : memref<?x?xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)

    // gpu.launch_func  @gemm_kernels::@gemm_kernel_wgX_256_wgY_128_Kblock_32_sgX_32_sgY_32_named_barrier blocks in (%wg_X, %wg_Y, %wg_Z) threads in (%sg_X, %sg_Y, %sg_Z) args(%A_gpu : memref<?x?xf16>, %B_gpu : memref<?x?xf16>, %C_gpu : memref<?x?xf16>, %M: index, %K: index, %N: index,%wg_M: index, %wg_K: index, %wg_N: index, %sg_M: index, %sg_K: index, %sg_N: index, %sg_X: index, %sg_Y: index, %prefetch_distance : index, %barrier_distance : index)

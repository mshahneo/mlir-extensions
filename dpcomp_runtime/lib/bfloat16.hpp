...
namespace std
{
    ...
    public:
        ...
        static constexpr gpu_runtime::bfloat16 min() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x007F);
        }
        static constexpr gpu_runtime::bfloat16 max() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x7F7F);
        }
        static constexpr gpu_runtime::bfloat16 lowest() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0xFF7F);
        }
        ...
        static constexpr gpu_runtime::bfloat16 epsilon() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x3C00);
        }
        static constexpr gpu_runtime::bfloat16 round_error() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x3F00);
        }
        ...
        static constexpr gpu_runtime::bfloat16 infinity() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x7F80);
        }
        static constexpr gpu_runtime::bfloat16 quiet_NaN() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x7FC0);
        }
        static constexpr gpu_runtime::bfloat16 signaling_NaN() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0x7FC0);
        }
        static constexpr gpu_runtime::bfloat16 denorm_min() noexcept
        {
            return gpu_runtime::bfloat16::from_bits(0);
        }
